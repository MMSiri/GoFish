...
namespace GoFish
{
    public class Player
    {
        ...
        /// <summary>
        /// Pluralise a word, adding "s" if value isn't equal to 1.
        /// </summary>
        public static string S(int s) => s == 1 ? "" : "s";

        /// <summary>
        /// Returns current player status: number of cards and books.
        /// </summary>
        ...
        /// <summary>
        /// If any cards I have match the value, return them. If I'm out of cards, get the next hand from the deck.
        /// </summary>
        /// <param name="value">Value asked for.</param>
        /// <param name="deck">Deck to draw next hand from.</param>
        /// <returns>Cards that were pulled out of other player's hand.</returns>
        ...
        /// <summary>
        /// When player receives cards from another player, adds them to the hand and pulls out any matching books.
        /// </summary>
        ...
        public void AddCardsAndPullOutBooks(IEnumerable<Card> cards)
        {
            ...
            var matchingBooksFound = hand.GroupBy(card => card.Value).Where(group => group.Count() == 4).Select(group => group.Key);

            books.AddRange(matchingBooksFound);
            books.Sort();
        ...
        /// <summary>
        /// Draws a card from the stock and adds to the player's hand.
        /// </summary>
        ...
        /// <summary>
        /// Gets random value from the player's hand.
        /// </summary>
        /// <returns>Value of a randomly selected card in the player's hand.</returns>
