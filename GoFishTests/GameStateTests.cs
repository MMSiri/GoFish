...
namespace GoFishTests
{
    ...
    public class GameStateTests
    {
        ...
        public void TestRandomPlayer()
        {
            ...
            var gameState = new GameState("Human", computerPlayerNames, new Deck());
            Player.Random = new PlayerTests.MockRandom() { ValueToReturn = 1 };
        ...
        public void TestPlayRound()
        {
            ...
            var cardsToAdd = new List<Card>()
            {
                ...
                //Cards game will deal to Brittney.
            ...
            Assert.AreEqual("Owen has asked Brittney for Jacks" + Environment.NewLine + "Brittney has 1 Jack card", message);
            ...
            Assert.AreEqual("Brittney has asked Own for Sixes" + Environment.NewLine + "Owen has 2 Six cards", message);
            Assert.AreEqual(1, owen.Books.Count());
            Assert.AreEqual(2, owen.Hand.Count());
        ...
        public void TestCheckForWinner()
        {
            ...
            Assert.AreEqual("The winners are Human and Computer1 and Computer2 and Computer 3", gameState.CheckForWinner());
        }
    }
}
