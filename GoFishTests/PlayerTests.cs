...
namespace GoFishTests
{
    ...
    public class PlayerTests
    {
        ...
        public void TestDoYouHaveAny()
        {
            ...
            var threes = player.DoYouHaveAny(Values.Three, new Deck()).Select(Card => Card.ToString()).ToList();
            ...
            var jacks = player.DoYouHaveAny(Values.Jack, new Deck()).Select(Card => Card.ToString()).ToList();
            CollectionAssert.AreEqual(new List<string>() { "Jack of Clubs", "Jack of Spades", }, jacks);
        ...
        /// <summary>
        /// Mock random that always returns a specified value (for testing purposes).
        /// </summary>
